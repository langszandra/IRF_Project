...
namespace beadando
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btnCreate_Click(object sender, System.EventArgs e)
        {
            ...
            DataColumn dc4 = new DataColumn("Vásárlás időpontja");
            ...
            dt.Rows.Add("langszandra", "22", "Female", "2020.11.10.");
            dt.Rows.Add("juhaszndora", "22", "Female","2020.12.01.");
            dt.Rows.Add("muskatkristof", "24", "Male", "2020.10.12.");
